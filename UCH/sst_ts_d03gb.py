...
for sn, sc in enumerate(scen):
    ...
    tso_gb.append(tso[:,ilat,ilon])
    tbo_gb.append(tbo[:,ilat,ilon])
...
ax.plot(np.linspace(1,12+27/31,len(tso_gb[0])),tso_gb[0],color='slateblue',\
        linewidth=8,alpha=.3)
l1,=ax.plot(np.linspace(1,12+27/31,len(tbo_gb[0])),tbo_gb[0],color='slateblue')

ax.plot(np.linspace(1,12+27/31,len(tso_gb[1])),tso_gb[1],color='gold',\
        linewidth=8,alpha=.3)
l2,=ax.plot(np.linspace(1,12+27/31,len(tbo_gb[1])),tbo_gb[1],color='gold')
...
ax2.plot(np.linspace(1,12+27/31,len(tbo_gb[0])),tso_gb[1]-tso_gb[0],color='firebrick',\
        linewidth=8,alpha=.3)
l3,=ax2.plot(np.linspace(1,12+27/31,len(tbo_gb[0])),tbo_gb[1]-tbo_gb[0],color='firebrick')
...
ax.text(9.1,30.3,'Guangbing location',fontsize=13)
