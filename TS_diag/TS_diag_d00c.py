...
del temp_sea,salt_sea,regions

#%% Penghu downscaling ==============================================
PH_ROMS = {}
root = '/data3/jhluna/work/ITRI_UCH_phdw/DATA/'
fnm = [root+'itri_uch_avg_d00c_his_zlev.nc', root+'itri_uch_avg_d00c_ssp_zlev.nc']
...
#del f,fnm,ftn,ilat,ilon,lat,lon,mon,rootgrp,so,to,time,time_units
del f,fnm,ftn,lat,lon,mon,rootgrp,so,to,time,time_units
