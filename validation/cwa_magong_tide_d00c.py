...
# =========================================================
# Read data -----------------------------------------------
with open('d00/cwa_obs/2013_1356_magong_tide.csv') as fnm:
...
time_roms = time_roms + np.timedelta64(8,'h')
...
ax[0].set_xlim([time_numeric[0],time_numeric[-1]])
...
ax[1].set_xlim([time_numeric[0],time_numeric[-1]])
